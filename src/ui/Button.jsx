...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const style = {
    ...
    secondary:
      "inline-block text-sm rounded-full border-2 px-4 py-2.5 md:py-3.5 md:px-6 border-stone-300 font-semibold uppercase tracking-wide hover:text-stone-800 focus:text-stone-800 transition-colors duration-300 hover:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed",
  };
